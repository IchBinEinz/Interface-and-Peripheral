...
; 0000 0074 // USART Transmitter: Off
...
; 0000 0077 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0078 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(16)
	OUT  0xA,R30
...
; 0000 0096       if(a==1)
	...
	BRNE _0x6
; 0000 0097       {
; 0000 0098         PORTC = 0x01; delay_ms(100);
	RJMP _0xA
; 0000 0099       }
; 0000 009A       else if(a==0)
_0x6:
	MOV  R0,R16
	OR   R0,R17
	BRNE _0x8
; 0000 009B       {
; 0000 009C         PORTC = 0x00; delay_ms(100);
	LDI  R30,LOW(0)
_0xA:
	OUT  0x15,R30
	LDI  R26,LOW(100)
