...
;//unsigned char cnt[10] = {0xc0,0xf9,0xa4,0xb0,0x99,0x92,0x82,0xf8,0x80,0x90};
;void main(void)
; 0000 001E {
...
; 0000 008A       {
; 0000 008B 
; 0000 008C       for(left=0;left<=9;left++)
	__GETWRN 18,19,0
_0x7:
	__CPWRN 18,19,10
	BRGE _0x8
; 0000 008D         {
; 0000 008E          for(right=0;right<=9;right++)
	__GETWRN 16,17,0
_0xA:
	__CPWRN 16,17,10
	BRGE _0xB
; 0000 008F          {
; 0000 0090            PORTC=right+(left*16);
	LDI  R26,LOW(16)
	MULS R18,R26
	MOVW R30,R0
	ADD  R30,R16
